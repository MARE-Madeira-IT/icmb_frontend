    ...
    .content {
        ...
        .info {
            ...
            p {
                ...
                margin: 0px;
                opacity: .7;
                width: calc(100vw - 200px); /* the element needs a fixed width (in px, em, %, etc) */
                        ...
                        <div className="card-body"
                            style={{ height: "500px", overflowY: "auto" }}>
                            {
                                props.chats?.map((chat) => (
                                    <Link style={{ textDecoration: "none" }} to={"/chats/" + chat.id} key={chat.id}>
                                        <Chatroom>
                                            <div className='image'>
                                            ...
                                            <div className='content'>
                                                ...
                                                <div className='details'>
                                                    <p className='date'>{dayjs(chat.message.created_at).fromNow()}</p>
