...
function Chat(props) {
    ...
    useEffect(() => {
        ...
        if (currentEcho) {
            currentEcho.channel(webSocketChannel)
    ...
    useEffect(() => {
        ...
        if (props.currentChat.id) {
            ...
            var cEcho = new Echo({
                ...
                cluster: "eu",
                encrypted: true,
                // authEndpoint: import.meta.env.VITE_API_URL + "/auth",   // As I'm using JWT tokens, I need to manually set up the headers.

                authEndpoint: import.meta.env.VITE_API_URL + "/channels/private_chats." + props.currentChat.socket,   // As I'm using JWT tokens, I need to manually set up the headers.
                auth: {
                    headers: {
                ...
                <div className="col-md-8">
                    <div className="card">
                        ...
                        <div className="card-footer">
                            <MessageInput user={props.currentUser} chat_id={id} createMessage={props.createMessage} />
                        </div>
                    </div>
                </div>
            </div>
